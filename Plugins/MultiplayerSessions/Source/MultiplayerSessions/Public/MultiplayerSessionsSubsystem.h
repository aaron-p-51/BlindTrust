...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FMultiplayerDestroyOnSessionComplete, bool, bWasSuccessful);
...
public:
	 ...
	 */
	 ...
	 FMultiplayerDestroyOnSessionComplete MultiplayerOnDestroySessionComplete;
